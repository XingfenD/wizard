                        ...
                        <td>
                            ...
                            @can('page-edit', $pageItem)
                                ...
                                <form id="form-attachment-del-{{ $attachment->id }}"
                                      action="{{ wzRoute('project:doc:attachment:delete', ['id' => $project->id, 'page_external_id' => $pageItem->external_id, 'attachment_id' => $attachment->id]) }}"
    ...
    <div class="card-body">
        <div class="wz-upload-box">
            ...
            <form class="form-horizontal" method="post"
                  action="{{ wzRoute('project:doc:attachment:upload', ['id' => $project->id, 'page_external_id' => $pageItem->external_id]) }}"
